...
# Awards
- [Net Awards 2015](https://thenetawards.com/). В частности, [open-source](https://thenetawards.com/vote/open-source/)
	- [ATOM](https://thenetawards.com/vote/open-source/atom/). A hackable text editor for the 21st Century
	- [FOUNDATION](https://thenetawards.com/vote/open-source/foundation/). The most advanced responsive front-end framework in the world.
	- [METEOR](https://thenetawards.com/vote/open-source/meteor/). Meteor is a complete open source platform for building web
	- [GULP](https://thenetawards.com/vote/open-source/gulp/). Automate and enhance your workflow
	- [BROWSERSYNC](https://thenetawards.com/vote/open-source/browsersync/). Time-saving synchronised browser testing. BrowserSync makes your tweaking and testing faster
