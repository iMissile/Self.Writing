...
- [ServerDB.io](http://demo.serverdb.io/). Articles:
  - [Introducing ServerDB Ц The CMDB You Actually Want to Use](http://devblackops.io/2015/03/24/introducing-serverdb-the-cmdb-you-actually-want-to-use/)
...
- [SysDB](https://sysdb.io/) Ч System DataBase. The system management and inventory collection service
...
- [Wise](http://www.wise.io/) Wise provides machine learning applications enabling to optimize customerТs experience across their lifecycle including acquisition, monetization, retention and support. Wise Applications use open APIs and OAuth to automatically connect to data. 
...
- [to-markdown](http://domchristie.github.io/to-markdown/) online конвертер текста. —сылка вз€та [отсюда](http://galengidman.com/2014/03/13/html-to-markdown-converter/)
